...
mod test_get {
    ...
    fn test01_mget_value_of_key_correct_is_success() {
        ...
        let _ = Set2::run(buffer_vec_mock_set1, &mut database_mock);
        let _ = Set2::run(buffer_vec_mock_set2, &mut database_mock);
        let result_received = Mget2::run(buffer_vec_mock_get, &mut database_mock);
    ...
    fn test02_mget_does_not_maintain_order() {
        ...
        let result_received = Mget2::run(buffer_vec_mock_get1, &mut database_mock);
        let excepted_vec = vec![
            "value2".to_string(),
            "(nil)".to_string(),
            "value1".to_string(),
        ...
        let result_received = Mget2::run(buffer_vec_mock_get2, &mut database_mock);
        let excepted_vec = vec![
            "(nil)".to_string(),
            "value2".to_string(),
            "value1".to_string(),
        ...
        let result_received = Mget2::run(buffer_vec_mock_get3, &mut database_mock);
        let excepted_vec = vec![
            "value1".to_string(),
            "value2".to_string(),
            "(nil)".to_string(),
