...
impl Notifiers {
    ...
    pub fn off_client(&self, client: &TcpStream) {
        ...
        self.command_delegator_sender
            .send((command_vec, sender_notify))
            .unwrap();
    ...
    pub fn send_command_delegator(
        ...
        self.command_delegator_sender.send((command, sender))
    }
    ...
    pub fn notify_successful_shipment(
        ...
        self.command_delegator_sender
            .send((command_vec_mod, sender_notify))
            .unwrap();
