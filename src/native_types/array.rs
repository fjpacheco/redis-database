use super::{bulk_string::RBulkString, error::ErrorStruct, redis_type::{RedisType, remove_first_cr_lf, verify_parsable_array_size}};
...
impl RedisType<Vec<String>> for RArray {
    ...
    fn decode(bulk_array: &mut String) -> Result<Vec<String>,ErrorStruct> { // 2 \r\n$ 3\r\nfoo\r\n $ 3\r\nbar\r\n
